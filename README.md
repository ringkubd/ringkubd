...
[![Website](https://img.shields.io/badge/Website-anwarjahid.com-blue?style=flat-square&logo=google-chrome)](https://anwarjahid.com)
[![Email](https://img.shields.io/badge/Email-ajr.jahid%40gmail.com-red?style=flat-square&logo=gmail)](mailto:ajr.jahid@gmail.com)
[![Fiverr](https://img.shields.io/badge/Fiverr-ringkubd-green?style=flat-square&logo=fiverr)](https://fiver.com/ringkubd)
...
I'm a **Technical Leader & Full-Stack Developer** with 8+ years (since Jul 2017) building scalable, production-grade web applications. I lead engineering teams and deliver backend APIs, responsive frontends, and high-quality mobile apps for enterprise and SaaS products.
...
- 🚀 **Founder & CTO** of [tmpmailer.com](https://tmpmailer.com) — Temporary email service with thousands of active users

- 💼 **Senior Full-Stack Developer** at [4POCH](https://4poch.com) — Haiti-based fintech & crypto exchange service
...
- ✅ **Delivery excellence:** Ship features reliably with low technical debt
- ✅ **Scalability:** Architect systems that scale to 100K+ users
- ✅ **Team growth:** Mentor and grow engineering teams
- ✅ **Problem solving:** Diagnose and resolve production issues quickly
...
### tmpmailer.com
- Temporary email service powering disposable inboxes and SMTP APIs; thousands of active users and lightweight web UI. [tmpmailer.com](https://tmpmailer.com)

### 4POCH
- Haiti-based fintech & crypto exchange providing KYC, payments, and wallet services for local markets. [4POCH](https://4poch.com)

### Gunma Halal Food
- Technical lead for frontend, backend and mobile apps (Android/iOS); improved SEO and user conversion for an e-commerce platform. [Gunma Halal Food](https://gunmahalalfood.com/)
